...
export function OnboardingAdminPassword() {
  // define hooks
  ...
  // if 'passwordState' not defined, get respetive previous section
  ...
  // define effects
  React.useEffect(() => setReady(password.length && checked ? true : false), [password, checked]);
    ...
    >
      <FormControl>
        <VStack pt={5} alignItems={"start"} width={"full"}>
          ...
          <Checkbox pt={4} pb={5} colorScheme="pink" checked={!checked} onChange={handleChangeCheck}>
